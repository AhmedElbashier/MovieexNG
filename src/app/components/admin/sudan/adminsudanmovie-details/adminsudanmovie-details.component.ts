...
import { AppMovieDialogComponent } from 'src/app/components/movie-details/app-movie-dialog/app-movie-dialog.component';
...
@Component({
  selector: 'app-adminsudanmovie-details',
  templateUrl: './adminsudanmovie-details.component.html',
  styleUrls: ['./adminsudanmovie-details.component.scss']
})
export class AdminsudanmovieDetailsComponent implements OnInit {
  public id: number;
  ...
  constructor(
    ...
    private adminService: AdminSdMoviesService
  ) {
  ...
  async getSingleMoviesDetails(id) {
    this.movie = await this.adminService.getMovie(id);
  }
