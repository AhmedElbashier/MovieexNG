...
@Component({
  selector: 'app-adminsudantv-details',
  templateUrl: './adminsudantv-details.component.html',
  styleUrls: ['./adminsudantv-details.component.scss']
})
export class AdminsudantvDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    private adminService: AdminSdTvsService
  ) {
  ...
  async getSingleMoviesDetails(id) {
    this.movie = await this.adminService.getTv(id);
  }
  ...
  openDialogMovie(video): void {
    ...
    this.dialog.open(AppAdminsudantvDetailsComponent, {
      height: "600px",
      width: "900px",
