...
@Component({
  selector: 'app-addsudanmovie',
  templateUrl: './addsudanmovie.component.html',
  styleUrls: ['./addsudanmovie.component.scss']
})
export class AddsudanmovieComponent implements OnInit {
  ...
  poster:string;
    ...
    constructor(private movieService:AdminSdMoviesService,private imageCompress: NgxImageCompressService) { }
