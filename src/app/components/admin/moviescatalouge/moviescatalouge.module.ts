...
import { MoviesCatalougeRoutingModule } from './MoviesCatalouge-routing.module';
...
@NgModule({
  ...
  declarations: [
    MoviesCatalougeComponent,
  ]
})
export class MoviesCatalougeModule {}
