...
export class AdminMoviesService {
  ...
  getAllMovies(): Observable<any> {
    // tslint:disable-next-line: max-line-length
    return this.http.get(`${this.systemUrl}Movie`);
  }
  ...
  //   return this.http.post<any>(this.systemUrl+"Movie", Movie).toPromise();
  // }
